...
public class CoffeeMaker {
	 ...
	 * @return String
	 */
	public static String deleteRecipe(int recipeToDelete) {
     ...
     * @return boolean
     */
    public static synchronized void addInventory(String amtCoffee, String amtMilk, String amtSugar, String amtChocolate) throws InventoryException {
     ...
     * @return int
     */
    public static synchronized int makeCoffee(int recipeToPurchase, int amtPaid) {
        int change = 0;
